...
def lane_fill_poly(binary_warped,undist,left_fit,right_fit, inverse_perspective_transform, offcenter):
    ...
    if abs(offcenter) > threshold:  # car is offcenter more than 0.6 m
        # Draw Red lane
        cv.fillPoly(color_warp, np.int_([pts]), (255, 0, 0)) # red
...
def img_pipeline(img):
    ...
    #draw polygon
    processed_frame = lane_fill_poly(birdseye, undist, left_fit, right_fit, inverse_perspective_transform, offset)
